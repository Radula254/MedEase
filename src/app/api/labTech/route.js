...
export async function PUT(req) {
  ...
  const {_id, name, image, ...otherLabTechInfo} = data;
  ...
  await LabTechInfo.findOneAndUpdate({email:user.email}, otherLabTechInfo, {upsert:true});
...
export async function GET(req) {
  ...
  return Response.json({...user, ...labTechInfo});
