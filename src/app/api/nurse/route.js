...
export async function PUT(req) {
  ...
  const {_id, name, image, ...otherNurseInfo} = data;
  ...
  await NurseInfo.findOneAndUpdate({email:user.email}, otherNurseInfo, {upsert:true});
...
export async function GET(req) {
  ...
  return Response.json({...user, ...nurseInfo});
