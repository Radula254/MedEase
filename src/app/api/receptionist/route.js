...
export async function PUT(req) {
  ...
  const {_id, name, image, ...otherReceptionistInfo} = data;
  ...
  await ReceptionistInfo.findOneAndUpdate({email:user.email}, otherReceptionistInfo, {upsert:true});
...
export async function GET(req) {
  ...
  return Response.json({...user, ...receptionistInfo});
